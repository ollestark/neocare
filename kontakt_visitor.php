    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="kontakt_visitor.php">Kontakt</a></li>

            </ul>
            <!--<ul class="nav navbar-nav navbar-right">
<li><a href="#" data-toggle="modal" data-target="#modalRegister"><span class="glyphicon glyphicon-user"></span> Registrera</a></li>
<li><a href="#" data-toggle="modal" data-target="#modalLogin"><span class="glyphicon glyphicon-log-in"></span> Logga in</a></li>
